...
interface Props {
  ...
  onSubmitted: () => void; // callback to trigger page refresh
}
...
export default function AssignmentSubmitPanel({
  ...
  async function handleSubmit() {
    ...
    // Trigger AI feedback asynchronously — don't block the UI
    if (assignmentId) {
  ...
  return (
    <div>
      ...
      {!open && !generatingAI && (
        <button
          onClick={() => { setOpen(true); setSuccess(false); setUrlError(''); }}
        ...
        <div style={{
          ...
          {assignmentBrief && (
            <div style={{
              ...
              <p style={{
                ...
                color: 'var(--amber-deep)', marginBottom: 6,
              }}>Assignment Brief</p>
          ...
          {isResubmission && (
            <div style={{
              ...
              background: 'rgba(197,116,58,0.07)',
              borderRadius: 4,
            }}>
              <p style={{ fontSize: '0.8125rem', color: 'var(--amber-deep)', fontWeight: 600 }}>
                Resubmission #{(existingAssignment?.resubmission_count || 0) + 1} — make sure
                you've addressed all of Genesis's feedback before resubmitting.
              </p>
            </div>
          )}
          ...
          <div className="form-group">
            ...
            />
            <p style={{
              fontSize: '0.75rem', marginTop: 5, fontWeight: urlError ? 600 : 400,
